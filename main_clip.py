...
from coco_dataset import CustomCocoCaptions
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = CustomCocoCaptions(root = '/workspaces/datasets/MS_COCO/train2017',
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.workers, pin_memory=True, sampler=train_sampler, drop_last=True, collate_fn=collate_fn)
...
def train(train_loader, model, optimizer, scaler, summary_writer, epoch, args):
    ...
    for i, (images, tokens) in enumerate(train_loader):
